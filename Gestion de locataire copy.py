...
class Application:
    def __init__(self, master):
        ...
        self.heading = Label(self.left, text="Gestion de locataire", font=(
            'georgia 40 bold'), fg='black', bg='grey')
        self.heading.place(x=0, y=0)
        # nom
        self.name = Label(self.left, text="Nom ", font=(
        ...
        # sexe
        self.sexe = Label(self.left, text="Sexe", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.sexe.place(x=0, y=180)

        # Adresse
        self.Adresse = Label(self.left, text="Adresse", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Adresse.place(x=0, y=220)

        # Heure d'entrée
        self.Heure = Label(self.left, text="Heure d'entrée", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Heure.place(x=0, y=260)

        # Num
        self.Num = Label(self.left, text="Num Tel", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Num.place(x=0, y=300)
        ...
        self.submit.place(x=200, y=340)
        
# button to perform a command
        self.submit = Button(self.left, text="Modifier", width=20,
                             height=2, bg='white', command=self.add_appointment)
        self.submit.place(x=400, y=340)
        
        # button to perform a command
        self.submit = Button(self.left, text="Supprimer", width=20,
                             height=2, bg='white', command=self.add_appointment)
        self.submit.place(x=600, y=340)
        ...
        self.logs = Label(self.right, text="Carnets de locataires", font=(
            'georgia 28 bold'), fg='black', bg='grey')
        self.logs.place(x=70, y=10)

        self.box = Text(self.right, width=150, height=40)
        self.box.place(x=20, y=60)
        self.box.insert(END, "Total des locataires jusqu'à maintenant : " +
                        str(self.final_id) + " \n")
