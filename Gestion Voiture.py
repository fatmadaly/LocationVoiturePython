...
class Application:
    def __init__(self, master):
        ...
        self.gestion = Label(self.left, text="Gestion de Voitures", font=(
            'georgia 40 bold'), fg='black', bg='grey')
        self.gestion.place(x=0, y=0)
        # Marque
        self.Marque = Label(self.left, text="Marque", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Marque.place(x=0, y=100)

        # Modele
        self.Modele = Label(self.left, text="Modele", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Modele.place(x=0, y=140)

        # Kilometrage
        self.Kilometrage = Label(self.left, text="Kilometrage", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Kilometrage.place(x=0, y=180)

        # Etat
        self.Etat = Label(self.left, text="Etat", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Etat.place(x=0, y=220)

        # Prix_location
        self.Prix_location = Label(self.left, text="Prix_location", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Prix_location.place(x=0, y=260)

        # Num_imma
        self.Num_imma= Label(self.left, text="Num_imma", font=(
            'georgia 18 bold'), fg='black', bg='grey')
        self.Num_imma.place(x=0, y=300)
        ...
        self.logs = Label(self.right, text="Carnets des voitures", font=(
            'georgia 28 bold'), fg='black', bg='grey')
        self.logs.place(x=70, y=10)

        self.box = Text(self.right, width=150, height=40)
        self.box.place(x=20, y=60)
        self.box.insert(END, "Total des voitures disponible jusqu'à maintenant : " +
                        str(self.final_id) + " \n")
